...
const Services = () => {
  return (
    <section  className="flex justify-center items-center p-5  flex-col bg-gradient-to-tr from-sky-200 to-indigo-600 " >
        ...
        <div className="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3  gap-10  " >
            {ServicesItem.map(( item) => <div key={item.id} className="shadow-md"  >
